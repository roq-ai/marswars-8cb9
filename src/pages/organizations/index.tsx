...
function OrganizationListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('organization', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/organizations/view/${id}`);
    }
  };
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('organization', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/organizations/create`} passHref legacyBehavior>
